...
public class HotelListControllerMIA {
    ...
    @FXML
    public void handleHotelPageActionMIA1(ActionEvent event) {
        try {
    ...
    @FXML
    public void handleHotelPageActionMIA2(ActionEvent event) {
        try {
            // Load and display HotelPage
            Parent root = FXMLLoader.load(getClass().getResource("/booking/fxml/HotelPage.fxml"));
            Stage stage = new Stage();
    ...
    @FXML
    public void handleHotelPageActionMIA3(ActionEvent event) {
        try {
            // Load and display HotelPage
            Parent root = FXMLLoader.load(getClass().getResource("/booking/fxml/HotelPage.fxml"));
            Stage stage = new Stage();
