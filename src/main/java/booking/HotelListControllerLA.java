...
public class HotelListControllerLA {
    ...
    @FXML
    public void handleHotelPageActionLA1(ActionEvent event) {
        try {
    ...
    @FXML
    public void handleHotelPageActionLA2(ActionEvent event) {
        try {
            // Load and display HotelPage
            Parent root = FXMLLoader.load(getClass().getResource("/booking/fxml/HotelPage.fxml"));
            Stage stage = new Stage();
    ...
    @FXML
    public void handleHotelPageActionLA3(ActionEvent event) {
        try {
            // Load and display HotelPage
            Parent root = FXMLLoader.load(getClass().getResource("/booking/fxml/HotelPage.fxml"));
            Stage stage = new Stage();
