...
public class HotelListControllerNOLA {
    ...
    @FXML
    public void handleHotelPageActionNOLA1(ActionEvent event) {
        try {
    ...
    @FXML
    public void handleHotelPageActionNOLA2(ActionEvent event) {
        try {
            // Load and display HotelPage
            Parent root = FXMLLoader.load(getClass().getResource("/booking/fxml/HotelPage.fxml"));
            Stage stage = new Stage();
    ...
    @FXML
    public void handleHotelPageActionNOLA3(ActionEvent event) {
        try {
            // Load and display HotelPage
            Parent root = FXMLLoader.load(getClass().getResource("/booking/fxml/HotelPage.fxml"));
            Stage stage = new Stage();
