...
/**
 * The booking.model.RoomType class represents the type of a room in a hotel.
...
public class RoomType {
    ...
    /**
     * Constructor to create a booking.model.RoomType object with a name and capacity.
