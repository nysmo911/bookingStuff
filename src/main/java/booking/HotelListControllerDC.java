...
public class HotelListControllerDC {
    ...
    @FXML
    public void handleHotelPageActionDC1(ActionEvent event) {
        try {
    ...
    @FXML
    public void handleHotelPageActionDC2(ActionEvent event) {
        try {
            // Load and display HotelPage
            Parent root = FXMLLoader.load(getClass().getResource("/booking/fxml/HotelPage.fxml"));
            Stage stage = new Stage();
    ...
    @FXML
    public void handleHotelPageActionDC3(ActionEvent event) {
        try {
            // Load and display HotelPage
            Parent root = FXMLLoader.load(getClass().getResource("/booking/fxml/HotelPage.fxml"));
            Stage stage = new Stage();
