...
public class HotelListControllerSEA {
    ...
    @FXML
    public void handleHotelPageActionSEA1(ActionEvent event) {
        try {
    ...
    @FXML
    public void handleHotelPageActionSEA2(ActionEvent event) {
        try {
            // Load and display HotelPage
            Parent root = FXMLLoader.load(getClass().getResource("/booking/fxml/HotelPage.fxml"));
            Stage stage = new Stage();
    ...
    @FXML
    public void handleHotelPageActionSEA3(ActionEvent event) {
        try {
            // Load and display HotelPage
            Parent root = FXMLLoader.load(getClass().getResource("/booking/fxml/HotelPage.fxml"));
            Stage stage = new Stage();
