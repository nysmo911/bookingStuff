...
public class HotelListControllerSF {
    ...
    @FXML
    public void handleHotelPageActionSF1(ActionEvent event) {
        try {
    ...
    @FXML
    public void handleHotelPageActionSF2(ActionEvent event) {
        try {
            // Load and display HotelPage
            Parent root = FXMLLoader.load(getClass().getResource("/booking/fxml/HotelPage.fxml"));
            Stage stage = new Stage();
    ...
    @FXML
    public void handleHotelPageActionSF3(ActionEvent event) {
        try {
            // Load and display HotelPage
            Parent root = FXMLLoader.load(getClass().getResource("/booking/fxml/HotelPage.fxml"));
            Stage stage = new Stage();
